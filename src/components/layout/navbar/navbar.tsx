...
export const Navbar = () => {
  ...
  return (
    <>
      <header
        className={`bg-white duration-150 sticky top-0 transform transition-transform z-30 md:transform-none md:dark:border-b dark:bg-dark-100 dark:border-dark-50 ${
      ...
      <nav
        ...
        className={`bg-white border-b dark:bg-dark-100 duration-150 flex sticky top-14 transform transition-transform z-30 md:hidden dark:border-dark-50 ${
          scrollDirection === 'down' ? '-translate-y-full' : 'translate-y-0'
        }`}
      >
        <NavbarLinks />
