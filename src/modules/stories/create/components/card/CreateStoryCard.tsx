  ...
  return (
    <div
      className={classNames({
        ...
        'primary-bg md:card-bg primary-transition group relative h-full min-w-28 overflow-hidden rounded-xl md:min-w-32':
          variant === 'list',
      })}
    >
      <Link
        className={classNames(
          'primary-transition group relative flex h-full p-3 md:rounded-lg md:px-2 md:py-1.5',
          {
      ...
      >
        ...
        >
          <PlusIcon
            className={classNames('primary-transition rounded-full stroke-1', {
