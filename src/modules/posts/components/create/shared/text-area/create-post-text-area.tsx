...
export const CreatePostTextArea = () => {
  ...
  return (
    <textarea
      className="bg-transparent focus:outline-none h-full pb-2 px-4 resize-none text-xl w-full md:h-40 md:text-2xl md:pb-0 dark:placeholder:text-smoke-300 dark:text-smoke-1000"
